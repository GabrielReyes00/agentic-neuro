...
- Do not query vault intelligence at startup for the requested document. The document itself plus SQLite recall plus Anki overlay are the startup context.

## First Question

Ask one question and stop. Do not provide hints, answer context, expected findings, named signs, thresholds, or teaching explanation until Gabriel answers or requests a reveal.
