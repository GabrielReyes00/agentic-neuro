...
Draft to `data/Sessions/shift_debrief_<slug>.md`; install to:
...
```bash
python3 src/shift_debrief_guard.py install --draft "data/Sessions/shift_debrief_<slug>.md" --title "<Topic Title>"
