...
description: Use when Gabriel asks for /generate-report, generate report, or the related workflow. Encyclopedic, citation-dense neurosurgical reference report — textbook-chapter ambition, agent-driven research and self-audit, vault write. Follows the shared agent-agnostic command contract.
---
