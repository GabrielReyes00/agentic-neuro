...
This is the compact tier selected by the parent retrieval router. Return to the
router when the appropriate tier is not already established; this leaf contract
does not choose its own upstream path.
